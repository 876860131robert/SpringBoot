...
public class MaterialsVO implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -401998550185206318L;
	private String id;//
	...
	public String toString() {
		return "MaterialsVO [id=" + id + ", pcategory=" + pcategory + ", category=" + category + ", brand=" + brand
				...
				+ remarks + ", startrow=" + startrow + ", pagesize=" + pagesize + "]";
	}
