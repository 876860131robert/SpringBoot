...
<head>
<meta charset="utf-8" />  
<link rel="shortcut icon" href="images/login.jpg" />
  ...
  <!--注册-->
    ...
    <div class="web_login"><form name="form2" id="regUser" accept-charset="utf-8"  action="http://www.js-css.cn" method="post">
        ...
        <ul class="reg_form" id="reg-ul">
                ...
                <li>
                    <div class="inputArea">
                        <input type="button" id="reg"  style="margin-top:10px;margin-left:85px;" class="button_blue" value="同意协议并注册"/> <a onclick="turnGo()" class="zcxy" target="_blank">注册协议</a>
                    </div>
